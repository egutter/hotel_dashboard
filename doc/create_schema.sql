  ...
  CREATE TABLE RESERVATION_NAME 
   ...
   COMMENT ON COLUMN RESERVATION_NAME.TAX_REGISTRATION_NO IS 'Tax Registration NUMERIC, Maldives Bed Tax Reporting';
 
   COMMENT ON COLUMN RESERVATION_NAME.VISA_NUMBER IS 'Visa NUMERIC, Maldives Bed Tax Reporting';
...
CREATE TABLE FINANCIAL_TRANSACTIONS
  (
    ...
    RECPT_NO                NUMERIC,
    RECPT_TYPE              VARCHAR(3),
    ROOM_CLASS              VARCHAR(20),
    TAX_INCLUSIVE_YN        VARCHAR(1) DEFAULT 'N',
    NET_AMOUNT              NUMERIC(38,12),
    GROSS_AMOUNT            NUMERIC(38,12),
    CHEQUE_NUMBER           VARCHAR(200),
    CASHIER_OPENING_BALANCE NUMERIC(38,12),
    ...
    FT_SUBTYPE      CHAR(5) ,
    TC_GROUP        VARCHAR(20) ,
    TC_SUBGROUP     VARCHAR(20) ,
    TRX_CODE        VARCHAR(20) ,
    TRX_NO_ADJUST   NUMERIC,
    TRX_NO_ADDED_BY NUMERIC,
    TRX_DATE DATE ,
    TRX_NO_AGAINST_PACKAGE NUMERIC,
    TRX_NO_HEADER          NUMERIC,
    AR_NUMBER              NUMERIC,
    BUSINESS_DATE DATE ,
    ROOM                 VARCHAR(20),
    TCL_CODE1            VARCHAR(20),
    CURRENCY             VARCHAR(20) ,
    FT_GENERATED_TYPE    VARCHAR(20),
    TCL_CODE2            VARCHAR(20),
    RESV_NAME_ID         NUMERIC,
    CASHIER_ID           NUMERIC,
    FOLIO_VIEW           NUMERIC(9,0),
    QUANTITY             NUMERIC(12,3),
    REMARK               VARCHAR(2000),
    REFERENCE            VARCHAR(2000),
    PRICE_PER_UNIT       NUMERIC(38,12),
    CREDIT_CARD_ID       NUMERIC,
    TRX_AMOUNT           NUMERIC(38,12),
    NAME_ID              NUMERIC,
    POSTED_AMOUNT        NUMERIC(38,12),
    MARKET_CODE          VARCHAR(20),
    GUEST_ACCOUNT_CREDIT NUMERIC(38,12),
    SOURCE_CODE          VARCHAR(20),
    RATE_CODE            VARCHAR(20),
    DEFERRED_YN          VARCHAR(1) DEFAULT 'N' ,
    EXCHANGE_RATE        NUMERIC(38,12) DEFAULT 0,
    GUEST_ACCOUNT_DEBIT  NUMERIC(38,12),
    CASHIER_CREDIT       NUMERIC(38,12),
    CASHIER_DEBIT        NUMERIC(38,12),
    PACKAGE_CREDIT       NUMERIC(38,12),
    PACKAGE_DEBIT        NUMERIC(38,12),
    DEP_LED_CREDIT       NUMERIC(38,12),
    DEP_LED_DEBIT        NUMERIC(38,12),
    HOTEL_ACCT           VARCHAR(20),
    IND_ADJUSTMENT_YN    VARCHAR(1),
    REASON_CODE          VARCHAR(20),
    TRAN_ACTION_ID       NUMERIC,
    FIN_DML_SEQ_NO       NUMERIC,
    ROUTING_INSTRN_ID    NUMERIC,
    FROM_RESV_ID         NUMERIC,
    O_TRX_DESC           VARCHAR(2000),
    PRODUCT              VARCHAR(20),
    NUMBER_DIALED        VARCHAR(40),
    GEN_CASHIER_ID       NUMERIC,
    REVENUE_AMT          NUMERIC(38,12),
    PASSER_BY_NAME       VARCHAR(200),
    AR_LED_CREDIT        NUMERIC(38,12),
    AR_LED_DEBIT         NUMERIC(38,12),
    AR_STATE             VARCHAR(2),
    FOLIO_NO             NUMERIC,
    INVOICE_NO           NUMERIC,
    INSERT_USER          NUMERIC,
    ...
    UPDATE_USER NUMERIC,
    UPDATE_DATE DATE ,
    FIXED_CHARGES_YN     VARCHAR(1) DEFAULT 'N',
    TA_COMMISSIONABLE_YN VARCHAR(1),
    EURO_EXCHANGE_RATE   NUMERIC(38,12),
    TAX_GENERATED_YN     VARCHAR(1) DEFAULT 'Y',
    ARRANGEMENT_ID       NUMERIC,
    TRNS_ACTIVITY_DATE DATE,
    TRNS_FROM_ACCT        NUMERIC,
    TRNS_TO_ACCT          NUMERIC,
    BILL_NO               NUMERIC,
    REVISION_NO           NUMERIC,
    RESV_DEPOSIT_ID       NUMERIC,
    TARGET_RESORT         VARCHAR(20),
    INH_DEBIT             NUMERIC(38,12),
    INH_CREDIT            NUMERIC(38,12),
    LINK_TRX_NO           NUMERIC,
    FOLIO_TYPE            VARCHAR(100),
    COMPRESSED_YN         VARCHAR(1),
    NAME_TAX_TYPE         VARCHAR(20),
    TAX_INV_NO            VARCHAR(20),
    PAYMENT_TYPE          VARCHAR(3),
    DISPLAY_YN            VARCHAR(1),
    COLL_AGENT_POSTING_YN VARCHAR(1),
    FISCAL_TRX_CODE_TYPE  VARCHAR(1),
    DEFERRED_TAXES_YN     VARCHAR(1),
    COMMENTS              VARCHAR(2000),
    AUTHORIZER_ID         NUMERIC,
    APPROVAL_CODE         VARCHAR(20),
    APPROVAL_DATE DATE,
    APPROVAL_STATUS    VARCHAR(20),
    TAX_ELEMENTS       VARCHAR(300),
    COMP_LINK_TRX_NO   NUMERIC,
    COMP_LINK_TRX_CODE VARCHAR(20),
    POSTING_DATE DATE,
    MTRX_NO_AGAINST_PACKAGE  NUMERIC,
    ADVANCED_GENERATE_YN     VARCHAR(1),
    CHECK_FILE_ID            VARCHAR(40),
    FOREX_TYPE               VARCHAR(1),
    FOREX_COMM_PERC          NUMERIC,
    FOREX_COMM_AMOUNT        NUMERIC,
    ARTICLE_ID               NUMERIC,
    TA_COMMISSION_NET_YN     VARCHAR(1),
    SOURCE_COMMISSION_NET_YN VARCHAR(1),
    TO_RESV_NAME_ID          NUMERIC,
    ROOM_NTS                 NUMERIC,
    COMP_TYPE_CODE           VARCHAR(20),
    COUPON_NO                VARCHAR(20),
    ORG_AR_LED_DEBIT         NUMERIC,
    SETTLEMENT_FLAG          VARCHAR(1),
    FISCAL_BILL_NO           VARCHAR(40),
    ACC_TYPE_FLAG            VARCHAR(1),
    PACKAGE_ALLOWANCE        NUMERIC(38,12),
    ORIGINAL_RESV_NAME_ID    NUMERIC,
    ORIGINAL_ROOM            VARCHAR(20),
    EXT_TRX_ID               VARCHAR(40),
    PROFIT_LOSS_FLAG         VARCHAR(1),
    CLOSURE_NO               NUMERIC,
    PROFORMA_YN              VARCHAR(1),
    ALLOWANCE_TYPE           VARCHAR(20),
    ADV_GENERATE_ADJUSTMENT  VARCHAR(10),
    ADV_GENERATE_TRX_CODE    VARCHAR(20),
    HOLD_YN                  VARCHAR(1),
    TRX_SERVICE_TYPE         VARCHAR(20),
    ORG_BILL_NO              NUMERIC,
    ORG_FOLIO_TYPE           VARCHAR(100),
    POSTING_TYPE             VARCHAR(20),
    PARALLEL_GUEST_CREDIT    NUMERIC(38,12),
    PARALLEL_GUEST_DEBIT     NUMERIC(38,12),
    PARALLEL_CURRENCY        VARCHAR(20),
    EXCHANGE_DIFFERENCE_YN   VARCHAR(1),
    MEMBERSHIP_ID            NUMERIC,
    PARALLEL_NET_AMOUNT      NUMERIC(38,12),
    PARALLEL_GROSS_AMOUNT    NUMERIC(38,12),
    EXCHANGE_TYPE            VARCHAR(2),
    EXCHANGE_DATE DATE,
    INSTALLMENTS          NUMERIC,
    CONTRACT_GUEST_DEBIT  NUMERIC,
    CONTRACT_GUEST_CREDIT NUMERIC,
    CONTRACT_NET_AMOUNT   NUMERIC,
    CONTRACT_GROSS_AMOUNT NUMERIC,
    CONTRACT_CURRENCY     VARCHAR(20),
    CALC_POINTS_YN        VARCHAR(1),
    AR_CHARGE_TRANSFER_YN VARCHAR(1),
    PROCESSED_8300_YN     VARCHAR(1),
    ASB_FLAG              VARCHAR(1),
    POSTIT_YN             VARCHAR(1),
    POSTIT_NO             NUMERIC,
    ROUTING_DATE DATE,
    PACKAGE_TRX_TYPE            VARCHAR(40),
    EXT_SYS_RESULT_MSG          VARCHAR(2000),
    AUTO_SETTLE_YN              VARCHAR(1),
    CC_TRX_FEE_AMOUNT           NUMERIC,
    CHANGE_DUE                  NUMERIC,
    POSTING_SOURCE_NAME_ID      NUMERIC,
    QUEUE_NAME                  VARCHAR(240),
    DEP_TAX_TRANSFERED_YN       VARCHAR(1),
    ESIGNED_RECEIPT_NAME        VARCHAR(200),
    BONUS_CHECK_ID              NUMERIC,
    AUTO_CREDITBILL_YN          VARCHAR(1),
    POSTING_RHYTHM              VARCHAR(20),
    FBA_CERTIFICATE_NUMBER      VARCHAR(20),
    EXP_ORIGINAL_INVOICE        VARCHAR(40),
    EXP_INVOICE_TYPE            VARCHAR(10),
    ASB_TAX_FLAG                VARCHAR(20),
    ASB_ONLY_POST_TAXES_ONCE_YN VARCHAR(1),
    ROUND_LINK_TRXNO            NUMERIC,
    ROUND_FACTOR_YN             VARCHAR(1),
    DEP_POSTING_FLAG            VARCHAR(1),
    EFFECTIVE_DATE DATE,
    PACKAGE_ARRANGEMENT_CODE VARCHAR(20),
    CORRECTION_YN            VARCHAR(1),
    ROUTED_YN                VARCHAR(1),
    UPSELL_CHARGE_YN         VARCHAR(1),
    ORG_POSTED_AMOUNT        NUMERIC(38,12),
    INC_TAX_DEDUCTED_YN      VARCHAR(1)
    );
